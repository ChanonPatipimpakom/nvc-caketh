...
/**
 * Servlet implementation class ShowPieServlet
 */
@WebServlet("/ShowPie")
public class ShowPieServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowPieServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("pie", orders);
		...
		ArrayList<Order> ordersc = new ArrayList<Order>();
		OrderService sv = new OrderService();
		ordersc = sv.getAllOrder();
		request.setAttribute("count", ordersc);
